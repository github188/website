...
if($action == 'post')
{
    ...
    elseif($do == 2)
    {
        ...
        if($$field==''){ 
        showMsg('带*号的为必填内容，请正确填写 <br />Please fill in the fields marked with *', '-1'); 
        exit(); 
        } 
        } 
        }else{ 
...
//      		echo "Fail to send. <p>";  
            ...
            if($diy->public == 2)
            {
                ...
                $bkmsg = 'Publish success, return form...';
            }
            else
            {
                $goto = !empty($cfg_cmspath) ? $cfg_cmspath : '/';
                $bkmsg = "Released successfully , waiting for administrator's disposal....";
            }
            showmsg($bkmsg, $goto);
        }
    }
