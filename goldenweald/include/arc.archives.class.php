...
class Archives
{
    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            {
                $this->PreNext['pre'] = "<a href='$mlink'>上一篇：NULL</a> ";
				$this->PreNext['prewap'] = "<a href=\"javascript:;\" class=\"page\" data-ignore=\"true\">上一条：NULL</a>  ";
            ...
            {
                $this->PreNext['next'] = "<a href='$mlink'>下一篇：NULL</a> ";
				$this->PreNext['nextwap'] = "<a href=\"javascript:;\" class=\"page\" data-ignore=\"true\">下一条：NULL</a> ";
